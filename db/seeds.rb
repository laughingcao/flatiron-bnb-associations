...
def make_seeds
  ...
  def make_reservations
    ...
    Reservation.create!(checkin: '2014-01-09', checkout: '2014-01-20', listing_id: 1, guest_id: 5 )
    Reservation.create!(checkin: '2014-04-25', checkout: '2014-04-30', listing_id: 1, guest_id: 4)
    # second listing 
    Reservation.create!(checkin: '2014-03-10', checkout: '2014-03-25', listing_id: Listing.find(2).id, guest_id: User.find_by(id: 5).id)
    # last listing
    Reservation.create!(checkin: '2014-06-02', checkout: '2014-06-30', listing_id: Listing.last.id, guest_id: User.find(6).id)
    Reservation.create!(checkin: '2014-05-15', checkout: '2014-06-01', listing_id: Listing.last.id, guest_id: User.find(5).id)
  end
